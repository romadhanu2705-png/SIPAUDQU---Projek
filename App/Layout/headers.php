    ...
    <div class="header-user">
      ...
      <div>
        <div style="font-size:0.82rem; font-weight:800; color:#1e293b;">
          <?= isset($studentName) ? htmlspecialchars($studentName) : 'Ahmad Fauzan Al Farizi' ?>
        </div>
        <div style="font-size:0.70rem; color:#64748b;">Wali Murid</div>
      </div>
    </div>
  </header>